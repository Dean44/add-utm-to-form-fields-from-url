...
// hide utm fields
document.getElementById("form_submission_custom_28").style.display = "none";
document.getElementById("form_submission_custom_29").style.display = "none";
document.getElementById("form_submission_custom_30").style.display = "none";
document.getElementById("form_submission_custom_31").style.display = "none";
